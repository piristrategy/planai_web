(() => {
  ...
  async function loadMorningBrief(retry) {
    ...
    try {
      ...
      const hint = isFile ? "<b>START_UI.bat</b> dosyas\u0131na \xE7ift t\u0131klay\u0131n, sonra F5 ile yenileyin." : "L\xFCtfen birka\xE7 dakika sonra yenileyin.";
      document.getElementById("briefEyebrow").textContent = "G\xFCnl\xFCk Sevkiyat \xB7 ba\u011Flant\u0131 yok";
      document.getElementById("briefSignals").innerHTML = `<div class="sig-line"><span class="t">\u2014</span><span class="icon" style="background:var(--fall)"></span><p><b>Platforma ula\u015F\u0131lamad\u0131</b> \u2014 ${hint}<span class="why">Neden \xF6nemli: ba\u011Flant\u0131 d\xFCzeldi\u011Finde canl\u0131 sabah brifingi otomatik y\xFCklenir.</span></p></div>`;
    }
  }
  ...
  function copyReport() {
    ...
    let extra = "";
    if (weeklyBody && weeklyBody.innerText && weeklyBody.innerText.indexOf("hen\xFCz yok") === -1) {
      extra += "\n\n--- Canl\u0131 Haftal\u0131k Intelligence Brief ---\n" + weeklyBody.innerText;
    }
    if (monthlyBody && monthlyBody.innerText && monthlyBody.innerText.indexOf("hen\xFCz yok") === -1) {
  ...
  function stBuild() {
    ...
    const liveLine = liveSignals.length ? `<div class="sig-line"><span class="t">CANLI</span><span class="icon" style="background:var(--rise)"></span><p><b>SQLite pazar kancas\u0131:</b> ${liveSignals.slice(0, 3).map(esc).join(" \xB7 ")}<span class="why">Kaynak: Pazar Nabz\u0131 / consumer_signals [GER\xC7EK veya TAHM\u0130N\u0130 rozetli]</span></p></div>` : "";
    const comps = ((hub.competitors || {}).move_cards || []).slice(0, 2);
    const compLine = comps.length ? `<div class="sig-line"><span class="t">RAK\u0130P</span><span class="icon" style="background:var(--fall)"></span><p><b>Canl\u0131 rakip kancas\u0131:</b> ${comps.map((c) => esc(c.name_tr || "")).join(" \xB7 ")}<span class="why">Kaynak: Rakip \u0130zleme / move_cards</span></p></div>` : "";
    document.getElementById("stOut").innerHTML = `
  <div class="dispatch"><div class="dispatch-head"><span class="cls">Strateji Tasla\u011F\u0131 \u2014 Canl\u0131 kancal\u0131 sim\xFClasyon</span><span class="mono" style="font-size:10px;color:var(--muted)">kitle: ${stSel.aud} \xB7 tema: ${stSel.theme} \xB7 b\xFCt\xE7e: ${stSel.bud}</span></div>
  <div class="dispatch-body">
    ...
    <div class="sig-line"><span class="t">MEDYA</span><span class="icon" style="background:var(--gold)"></span><p><b>Kanal karmas\u0131:</b> ${t.med}<span class="why">B\xFCt\xE7e uyarlamas\u0131: ${STBUD[stSel.bud]}</span></p></div>
    <div class="sig-line"><span class="t">\xD6L\xC7\xDCM</span><span class="icon" style="background:var(--rise)"></span><p><b>Ba\u015Far\u0131 g\xF6stergeleri:</b> ${t.kpi}<span class="why">Kan\u0131t zinciri: her g\xF6sterge kay\u0131t defterindeki bir kayna\u011Fa ba\u011Flan\u0131r</span></p></div>
    ${liveLine}${compLine}
  </div></div>
  <div class="note" style="margin-top:14px"><b>D\xFCr\xFCstl\xFCk notu:</b> \u015Fablon sim\xFClasyondur; CANLI/RAK\u0130P sat\u0131rlar\u0131 SQLite hub'dan gelir. Tam otomatik strateji motoru sonraki s\xFCr\xFCmde.</div>`;
  }
  function ask(i) {
    const t = document.getElementById("advThread");
    t.insertAdjacentHTML("beforeend", `<div class="msg q">${QA[i].q}</div>`);
    setTimeout(() => {
      t.insertAdjacentHTML("beforeend", `<div class="msg a">${QA[i].a}</div>`);
  ...
  var intelligenceCache, somFilter, VIEW_MODE_KEY, CIRCLED_NUM, _workstationCache, _workstationPollTimer, TR_CACHE_KEY, confToggle, liveDeltaState, sessionNotes, stSel, ST, STAUD, STBUD, QA;
  var init_destination_core = __esm({
    "assets/js/destination.core.js"() {
      ...
      ST = {
        kis: { dest: "Antalya + Alanya (12-ay \xFCr\xFCn)", win: "Ekim lansman\u0131 \u2192 Kas\u0131m\u2013Aral\u0131k yo\u011Funluk (rezervasyon dalgas\u0131 \xFCst\xFCne)", med: 'Facebook topluluk + YouTube aile yarat\u0131c\u0131lar\u0131 + SEM savunmas\u0131 ("gdzie ciep\u0142o w grudniu")', kpi: "K\u0131\u015F-g\xFCne\u015Fi arama pay\u0131 \xB7 hub trafi\u011Fi \xB7 Ara\u2013\u015Eub PL var\u0131\u015Flar\u0131 (resm\xEE istatistik)" },
        gastro: { dest: "Gaziantep + Kapadokya hatt\u0131 (UNESCO gastronomi \xE7\u0131pas\u0131)", win: "Q3 i\xE7erik \xFCretimi \u2192 sonbahar bas\u0131n gezisi \u2192 Q1 amplifikasyon", med: "Onet/WP editoryal i\u015F birli\u011Fi + deneyim yarat\u0131c\u0131lar\u0131 (IG/YT)", kpi: '"wakacje gastronomiczne" g\xF6r\xFCn\xFCrl\xFC\u011F\xFC \xB7 citation kazan\u0131m\u0131 \xB7 bas\u0131n yans\u0131mas\u0131' },
        kultur: { dest: "\u0130stanbul + Kapadokya + Efes \xFC\xE7geni", win: "\u0130lkbahar/sonbahar omuz sezonlar\u0131 (Maj\xF3wka penceresi dahil)", med: 'PL medya i\u015F birlikleri + kar\u015F\u0131la\u015Ft\u0131rma i\xE7eri\u011Fi ("kultura: Turcja czy W\u0142ochy")', kpi: "K\xFClt\xFCr-niyeti SoM \xB7 omuz-sezon var\u0131\u015Flar\u0131" }
      };
      STAUD = { aile: 'aile-de\u011Fer yarat\u0131c\u0131lar\u0131, okul-tatili takvim kilidi, "z dzie\u0107mi" dil e\u015Flemesi', cift: "balay\u0131 kay\u0131p-niyetini a\xE7an romantik varl\u0131klar (Kapadokya balon, Bodrum), premium \xE7er\xE7eve", deneyim: "macera/do\u011Fa dikeyi (adventure.goturkiye) + s\xFCrd\xFCr\xFClebilirlik rozetleri" };
      STBUD = { dusuk: "Owned i\xE7erik + SEM-savunma a\u011F\u0131rl\u0131kl\u0131; yarat\u0131c\u0131 i\u015F birli\u011Fi 1\u20132 mikro", orta: "\u0130\xE7erik + 3\u20135 yarat\u0131c\u0131 + Onet/WP i\u015F birli\u011Fi dengesi", yuksek: "Yukar\u0131s\u0131 + bas\u0131n gezisi + fuar (TT Warsaw) aktivasyonu" };
      QA = [
        {
          q: "\xD6n\xFCm\xFCzdeki \xE7eyrekte k\u0131\u015F b\xFCt\xE7esini nereye koyay\u0131m?",
          a: `<b>\xD6neri: b\xFCt\xE7enin a\u011F\u0131rl\u0131\u011F\u0131n\u0131 Facebook + k\u0131\u015F-g\xFCne\u015Fi i\xE7erik hatt\u0131na, Ekim lansman\u0131yla.</b><br><br><b>Neden:</b> K\u0131\u015F g\xFCne\u015Fi T\xFCrkiye'nin rakipsiz sezonu; Polonyal\u0131 12 ay u\xE7uyor, Yunanistan/H\u0131rvatistan bu rafta yok.<br><b>Kan\u0131t:</b> Kas\u0131m\u2013Aral\u0131k ikinci talep tepesi [GER\xC7EK] \xB7 Rainbow k\u0131\u015F katalo\u011Fu erken a\xE7\u0131ld\u0131 [GER\xC7EK] \xB7 "gdzie ciep\u0142o w grudniu" +24% [GER\xC7EK].<br><b>Beklenen etki:</b> Aral\u0131k rezervasyon dalgas\u0131nda operat\xF6r-ba\u011F\u0131ms\u0131z resm\xEE g\xF6r\xFCn\xFCrl\xFCk; k\u0131\u015F pay\u0131nda \xF6l\xE7\xFClebilir savunma.<br><b>G\xFCven:</b> Y\xFCksek.<br><b>Alternatifler:</b> (a) SEM-a\u011F\u0131rl\u0131kl\u0131 savunma \u2014 h\u0131zl\u0131 ama kal\u0131c\u0131 varl\u0131k b\u0131rakmaz \xB7 (b) Yaz 2027'ye saklamak \u2014 k\u0131\u015F avantaj\u0131 savunmas\u0131z kal\u0131r.`
        },
        {
          q: "Arnavutluk dizisine cevap verelim mi, yoksa g\xF6rmezden mi gelelim?",
          a: '<b>\xD6neri: polemi\u011Fe girmeyin; "Turcja vs Albania \u2014 rodzinne wakacje" veri-temelli kar\u015F\u0131la\u015Ft\u0131rmas\u0131yla \xE7er\xE7eveyi devral\u0131n.</b><br><br><b>Neden:</b> "Yeni T\xFCrkiye" \xE7er\xE7evesini reddetmek onu b\xFCy\xFCt\xFCr; kar\u015F\u0131la\u015Ft\u0131rma format\u0131 ise AI motorlar\u0131n\u0131n en \xE7ok al\u0131nt\u0131lad\u0131\u011F\u0131 i\xE7erik t\xFCr\xFCd\xFCr ve g\xFC\xE7l\xFC oldu\u011Funuz eksene (aile altyap\u0131s\u0131, u\xE7u\u015F derinli\u011Fi, 12 ay) \xE7eker.<br><b>Kan\u0131t:</b> WP dizisi 12K+ payla\u015F\u0131m [GER\xC7EK] \xB7 Arnavutluk ITAKA katalo\u011Funda [GER\xC7EK] \xB7 u\xE7u\u015F/altyap\u0131 k\u0131yas\u0131 T\xFCrkiye lehine [GER\xC7EK].<br><b>Beklenen etki:</b> "Turcja czy Albania" sorgular\u0131nda al\u0131nt\u0131lanabilir tek yap\u0131land\u0131r\u0131lm\u0131\u015F kaynak olmak.<br><b>G\xFCven:</b> Orta-Y\xFCksek \u2014 format kan\u0131tl\u0131, etki uygulamaya ba\u011Fl\u0131.<br><b>Alternatifler:</b> (a) Sessizlik \u2014 \xE7er\xE7eve rakipte kal\u0131r \xB7 (b) PR itiraz\u0131 \u2014 savunmac\u0131 g\xF6r\xFCn\xFCr, diziyi b\xFCy\xFCt\xFCr.'
        },
        {
          q: "Ankara'ya bu ay hangi g\xF6stergeyi raporlamal\u0131y\u0131m?",
          a: '<b>\xD6neri: \xFC\xE7l\xFC bir g\xF6sterge seti \u2014 pazar s\u0131ras\u0131 (#4), erken-rezervasyon a\xE7\u0131\u011F\u0131 (\u2212%22) ve "kay\u0131p \xFC\xE7 niyet" f\u0131rsat \xE7er\xE7evesi.</b><br><br><b>Neden:</b> Tek bir \xF6vg\xFC metri\u011Fi yerine "g\xFC\xE7l\xFC konum + ger\xE7ek risk + net plan" \xFC\xE7l\xFCs\xFC, hem g\xFCvenilirlik hem b\xFCt\xE7e gerek\xE7esi kurar.<br><b>Kan\u0131t:</b> #4 s\u0131ra [GER\xC7EK] \xB7 \u2212%22 erken rezervasyon [GER\xC7EK] \xB7 balay\u0131/gastronomi/wellness bo\u015Flu\u011Fu [TAHM\u0130N\u0130 \u2014 b\xF6yle etiketleyerek raporlay\u0131n].<br><b>Beklenen etki:</b> Merkez nezdinde "sorunu erken g\xF6ren, plan\u0131 haz\u0131r m\xFC\u015Favirlik" konumu; k\u0131\u015F kampanya b\xFCt\xE7esine zemin.<br><b>G\xFCven:</b> Y\xFCksek.<br><b>Alternatifler:</b> Yaln\u0131zca var\u0131\u015F istatisti\u011Fi raporlamak \u2014 gecikmeli g\xF6stergedir, \xF6nc\xFC sinyal de\u011Feri ta\u015F\u0131maz.'
        }
      ];
  ...
  // assets/js/app.js
  init_destination_core();
  var OFFLINE_HINT = "<b>CALISTIR.bat</b> veya <b>START_UI.bat</b> dosyas\u0131na \xE7ift t\u0131klay\u0131n, sonra F5 ile yenileyin.";
  function showApiOfflineBanner() {
    ...
    if (sig && sig.textContent.indexOf("y\xFCkleniyor") !== -1) {
      sig.innerHTML = '<div class="sig-line"><span class="t">\u2014</span><span class="icon" style="background:var(--fall)"></span><p><b>Platforma ula\u015F\u0131lamad\u0131</b> \u2014 ' + OFFLINE_HINT + '<span class="why">Neden \xF6nemli: ba\u011Flant\u0131 d\xFCzeldi\u011Finde canl\u0131 sabah brifingi otomatik y\xFCklenir.</span></p></div>';
    }
  }
