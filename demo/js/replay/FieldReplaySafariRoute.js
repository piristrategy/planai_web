...
(function (global) {
  ...
  const MAP_OVERLAY_BOOT = [
    ...
    'var dotFeats=c.map(function(pt){return{type:"Feature",properties:{},geometry:{type:"Point",coordinates:pt}};});',
    'var dotData={type:"FeatureCollection",features:dotFeats};',
    'try{',
    'var src=map.getSource("planai-route-safari");',
    'if(!src||!map.getLayer("planai-route-safari-line")){clearRouteLayers(map);',
    ...
    'paint:{"circle-radius":3,"circle-color":"#27ae60","circle-opacity":0.9,"circle-stroke-width":1,"circle-stroke-color":"#ffffff"}});',
    '}else{dotSrc.setData(dotData);}',
    '}catch(e){}',
    '}',
